...
const Details = () => {
    return (
        <div className="overflow-x-hidden">
            ...
            <ContainerWrapper>
                <div className="max-w-[1070px] mx-auto text-center mt-[-430px] lg:mt-[-440px] mb-[50px] relative z-10">
                    <p className='text-[rgba(255,255,255,0.90)] text-[18px] lg:text-[16px] md:text-[14px] font-[500] text-center mb-[30px]'>An AI-driven strategy executing trades across the top 100 crypto assets. Signal-based, high-frequency. Autonomous AI Strategies. Real Returns. Decentralized Execution. Knidos is your on-chain AI fund manager. Choose from three optimized pools and let our algorithm do the work—while you stay in control.</p>
                    <ul className='text-center flex justify-center items-start gap-[50px] text-white font-[700] text-[18px] lg:text-[16px] md:text-[14px] space-grotesk mb-[40px] lg:flex-wrap gap-y-[10px]'>

...
const DeleteAccount = () => {
    return (
        <div className="bg-[rgba(255,255,255,0.05)] rounded-[15px] overflow-hidden p-[30px]">
            <div className="flex items-center justify-start gap-[10px]">
                <div className="h-[50px] w-[50px] rounded-[15px] flex items-center justify-center text-[#FF1F1F] bg-[rgba(255,255,255,0.10)]">
            ...
            <div className="flex items-center justify-between gap-[10px] bg-[rgba(255,255,255,0.05)] px-[15px] py-[10px] rounded-[15px] mt-[20px]">
                ...
                <Link href="#" className="flex items-center justify-center h-[27px] px-[10px] text-[#FF1F1F] text-[16px] font-[700] space-grotesk border-[1px] bg-[rgba(255,31,31,0.05)] rounded-[8px] border-[rgba(255,31,31,0.30)]">
                    Delete
                </Link>
            </div>
        </div>

      ...
      <div className="relative">
        <div className="flex justify-between max-w-[300px] mb-[25px] p-[10px] rounded-[15px] overflow-hidden gap-[20px] bg-[rgba(255,255,255,0.05)]">
          <button
            ...
            className={`flex items-center justify-center text-[16px] font-[700] space-grotesk border-0 gap-[8px] rounded-[12px] px-[16px] py-[5px] h-[44px] transition hover:bg-[rgba(255,255,255,0.10)] hover:text-[#38FF3F] ${
              activeTab === "deposit"
          ...
          >
            <span>
              <Icon icon="bx:arrow-from-bottom" width="24" height="24" />
            </span>{" "}
            Deposit
          </button>
          <button
        ...
        {activeTab === "withdraw" && (
          <div className="withdraw-content">
            {/* ✅ You can design withdraw UI later */}

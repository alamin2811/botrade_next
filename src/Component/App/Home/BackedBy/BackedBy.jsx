...
const BackedBy = () => {
    return (
        <div className='py-[80px] relative flex items-center justify-center z-0'>
            <img src="./assets/images/shape/mesh-green.png" alt="img" className='absolute z-0 max-w-[55%] m-auto' />
            <ContainerWrapper>
                <div className="relative z-10">
                    <h3 className='text-center font-[700] mb-[30px] text-white space-grotesk text-[24px]'>Backed By</h3>
                    <img src="./assets/images/logo/avalanche-logo.png" alt="icon" className='nax-w-[380px] text-center mx-auto mb-[40px]' />
                    <p className='text-[18px] font-[500] text-[rgba(255,255,255,0.90)] mb-[50px] text-center leading-[150%]'>More strategies launching soon. Join our community for updates.</p>

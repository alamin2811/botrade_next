...
const HomeBanner = () => {
  return (
    <div className='bg-cover bg-no-repeat bg-center' style={{ backgroundImage: 'url(/assets/images/bg/home-banner-bg.png)' }}>
      <div className="overlay pt-[275px] xl:pt-[200px] lg:pt-[150px] md:pt-[120px] pb-[225px] md:pb-[200px]" style={{ background: 'linear-gradient(0deg, #0D1014 0%, rgba(13, 16, 20, 0.50) 100%)' }}>
        <ContainerWrapper>
          <div className="max-w-[868px] md:max-w-[600px] mx-[auto]">
            <h1 className='text-[70px] xl:text-[60px] lg:text-[50px] md:text-[40px] xsm:text-[36px] font-[700] uppercase text-white space-grotesk leading-[130%] text-center mb-[25px] xl:mb-[15px]'>Smarter Crypto Trades with Automation</h1>
            <h3 className='text-[36px] xl:text-[32px] lg:text-[28px] md:text-[24px] xsm:text-[22px] font-[700] uppercase text-white space-grotesk leading-[130%] text-center mb-[35px] xl:mb-[25px] lg:mb-[15px]'>AI Based Investment Pools</h3>
            <p className='text-[18px] xl:text-[16px] ld:text-[15px] md:text-[14px] font-[500] text-[rgba(255,255,255,0.90)] text-center mb-[50px] xl:mb-[40px] lg:mb-[30px] md:mb-[20px]'>Experience the future of DeFi with our AI-based investment pools. Advanced algorithms, autonomous strategies, and real returns—all on-chain and decentralized.</p>

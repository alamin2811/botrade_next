        ...
        <div className='bg-no-repeat pt-[210px] xl:pt-[150px] lg:pt-[100px] pb-[435px] relative z-0' style={{ background: 'url(./assets/images/bg/breadcumbs-banner-bg.png)', backgroundSize: 'cover' }}>
            <ContainerWrapper>
                <div className="relative">
                    <Link href="#" className={`text-white ${display} items-center justify-center absolute top-[-50px] lg:top-[0px] lg:relative lg:mb-[20px] left-0 gap-[6px] text-[16px] lg:text-[14px] font-[700] space-grotesk rounded-[12px] bg-[rgba(255,255,255,0.10)] w-[100px] lg:w-[80px] h-[40px] lg:h-[34px]`}><Icon icon="mynaui:arrow-left" width="20" height="20" /> Back</Link>
